...
numvars = [
    "Attrition_Flag", 'Customer_Age', 'Months_on_book', 'Total_Amt_Chng_Q4_Q1', 'Total_Trans_Ct' ]
catvars = [
    'Gender', 'Income_Category', 'Card_Category', 'Education_Level'
    ]
...
confusion_matrix
fig = px.imshow(confusion_matrix, text_auto = True, color_continuous_scale='RdBu_r')
